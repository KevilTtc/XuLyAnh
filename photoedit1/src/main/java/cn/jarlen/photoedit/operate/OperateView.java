...
//	private Context mContext;
	private boolean isMultiAdd;// true Nó có nghĩa là bạn có thể thêm nhiều hình ảnh watermark (hoặc văn bản), false nghĩa là bạn chỉ có thể thêm một hình ảnh watermark (hoặc văn bản) duy nhất
	private float picScale = 0.4f;
	/**
	 * Đặt kích thước ban đầu của hình mờ
	 * @param picScale
	 */
	...
	/**
	 *
	 * Đặt xem bạn có thể thêm nhiều ảnh hoặc đối tượng văn bản hay không
	 * @param isMultiAdd
	 *            true Nó có nghĩa là bạn có thể thêm nhiều hình ảnh watermark (hoặc văn bản), false nghĩa là bạn chỉ có thể thêm một hình ảnh watermark (hoặc văn bản) duy nhất
	 */
...
//		this.mContext = context;
	...
	/**
	 * Thêm đối tượng ảnh vào Chế độ xem
	 * 
	 * @param imgObj
	 *            Đối tượng hình ảnh
	 */
	...
	/**
	 * Vẽ tất cả các hình ảnh trong vùng chứa
	 */
	@Override
	...
	/**
	 * Vẽ lại Chế độ xem dựa trên điểm tiếp xúc
	 */
	@Override
	...
	/**
	 *
	 * Lấy đối tượng đã chọn ImageObject
	 * @return
	 */
	...
	/**
	 * Cung cấp các sự kiện giám sát nhấp đúp bên ngoài (nhấp đúp vào hộp thoại tùy chỉnh bật lên để chỉnh sửa văn bản)
	 */
