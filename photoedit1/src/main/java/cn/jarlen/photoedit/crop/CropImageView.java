...
public class CropImageView extends FrameLayout {
     ...
     *
     * Đặt bản đồ tài nguyên cắt
     * @param bitmap
     *
     * Cắt bản đồ tài nguyên
     */
   ...
   */
     ...
     * Đặt tỷ lệ cắt theo tỷ lệ cố định
     * Bây giờ đặt setFixedAspectRatio (true)
     * 
     * Ví dụ: cropImage.setAspectRatio (40, 30); là cắt tỷ lệ khung hình 40:30
     * Tỷ lệ chiều cao
     * @param 
    ...
    public void reverseImage(CropImageType.REVERSE_TYPE type)
    {
    	...
    	{
    		matrix.postScale(1, -1);//Lộn ngược
    	}
    	else if(type == CropImageType.REVERSE_TYPE.LEFT_RIGHT)
    	{
    		matrix.postScale(-1, 1);;//Lật trái và phải
    	}
    ...
    /**
     * Thay đổi kiểu của các góc của hộp cắt
     * 
     * @param bit
     * Phong cách hình ảnh
     * bit = null Khi, mặc định là cạnh góc màu trắng
     * 
     */
